...
(function() {
  ...
  const CHAPTERS = [
    ...
    { num: '09',    file: '09-quality.html',                    title: '幻觉防御+质量提升',   emoji: '✨' },
    { num: '10',    file: '10-methodology.html',                title: '纵横分析法',          emoji: '🎯' },
    { num: '11',    file: '11-train.html',                      title: '训练 vs 编排',        emoji: '🎓' },
    { num: '12',    file: '12-workflow.html',                   title: '个人 Workflow 5阶段', emoji: '🔄' },
    { num: '13',    file: '13-agent-cases.html',                title: '6大实战案例 ⭐',      emoji: '🤖' },
    { num: '14',    file: '14-demo.html',                       title: '现场演示 90分钟',     emoji: '🎬' },
    { num: '15',    file: '15-qa.html',                         title: 'Q&A 预判',            emoji: '❓' },
    { num: '16',    file: '16-live-demo.html',                  title: '真实召唤 LIVE',       emoji: '🎥' },
    { num: '17',    file: '17-case.html',                       title: '实战案例综述',        emoji: '📚' },
  ];
